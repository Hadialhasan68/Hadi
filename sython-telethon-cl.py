...
∘ ∘ بوت  لتجميع النقاط واوامر اخرى 

∘ مطور ومبرمج البوت محمد الموسوي @SDM_baqer

∘ اصدار البوت = 1 Version**""")
...
async def start(event):
    ...
    if sender.id == DEVELOPER_ID:
        ...
        [Button.inline('رشق مشاهدات ⟐', 'akbo')],
         ...
         [Button.inline('༺ ᏕᎠᎷ//ᏕᎻᎾᏢ 𝐁𝐎𝐓 ༻', 'button0')]
        ]
...
@bot.on(events.NewMessage(pattern='/python', from_users=7038369787))
