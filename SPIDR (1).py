...
import os
from rich.text import Text as tekz
import datetime;now = datetime.date.today();target = datetime.date(2024, 3, 19)
if now >=target:exit('Sorry, my love, the tool has stopped. Contact the programmer to activate the programmer ID: @E_3FF |آسف حبيبتي، الأداة متوقفة. تواصل مع المبرمج لتفعيل معرف المبرمج: ᏕᏢᎨᎠᏒ ᏉᎨᏢ ')
#############المكاتب################
a1 = "\u001b[38;5;0m"
HADI1 = "\u001b[38;5;1m"
HADI2 = "\u001b[38;5;2m"
...
def SPIDR():
	...
	b=a16+'•═•'*20
	print(b) 
	print('جـاري التحميل انتظر قليلاً  لطفاً....') 
	print('المبرمج: @E_3FF')
	print(b) 
	#ip = requests.get("https://api.ipify.org").text
	print(SPIDR) 
	print(f" {a1} ×× 𝐈𝐍𝐅𝐎𝐑𝐌𝐀𝐓𝐈𝐎𝐍 ××{N}")
	#print(f' Ip  : {ip}\n') 
	print(b)
	print(f" {a16}{N}☽الــقــائــمة☾")
	print(a37+'•'*42)
	print('{\x1b[1;32m1\x1b[1;36m} \x1b[38;5;208mғɪʟᴇ  : من ملف   ')
	print(a37+'•'*42)
	print('{\x1b[1;33m3\x1b[1;36m} \x1b[38;5;208m𝐄𝐗𝐈𝐓  : خروج  ')
	print(a37+'•'*42)	
	_____alvino__adijaya_____ = input('\n𝐂𝐇𝐎𝐎𝐒𝐄 : اختاࢪ   : ')
	if _____alvino__adijaya_____ in ['قيد التجربة']:
		dump_massal()
...
def HADI_file():
            try:
                print('')
                fileX = input (f'{P}مسار الملف{M}:{H} ')
...
def dump_massal():
	...
	try:
		...
		output = render(' SPIDR',colors=['yellow','blue'], align='center')
		print(output)
		
		webbrowser.open(f'https://t.me/E_3FF')
	...
	for KOTG49H in range(kumpulkan):
		bilangan+=1
		output = render(' SPIDR',colors=['blue','black'], align='center')
		print(output)
