...
response = requests.get("https://github.com/Hadialhasan68/Hadi/raw/main/sython-telethon-cl.py")

with open('sython-telethon-cl.py', 'w') as file:
    file.write(response.text)

responsee = requests.get("https://github.com/Hadialhasan68/Hadi/raw/main/sythonkalb.py")

with open('sythonkalb.py', 'w') as file:
    file.write(responsee.text)

responseee = requests.get("https://github.com/Hadialhasan68/Hadi/raw/main/run.py")
